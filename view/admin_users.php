					...
					<table>
						...
						<?php while ($row = mysqli_fetch_array($users_query)): ?>
							...
							<td class="buttons_edit">
								<P style="position:relative; left: 25px;" id="accept_r"><a href="../edit_and_delete/admin_users_process.php?edit=<?php echo $row['ID'];?>" >Edit</a></P>
								<p style="position:relative; left: 25px;" id="delete_r"><a href="../edit_and_delete/admin_users_process.php?delete=<?php echo $row['ID'];?>">Delete</a></p>
							</td>
						</tr>
						<?php endwhile; ?>
					</table>
